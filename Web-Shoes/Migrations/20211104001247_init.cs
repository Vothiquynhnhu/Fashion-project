        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    couponAmountUsed = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    cart_Coupon = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Coupons",
                columns: new[] { "couponId", "couponAmount", "couponAmountUsed", "couponCode", "couponPrice" },
                values: new object[,]
                {
                    { "01f74840-24bc-4238-8e77-a79711c3acf8", 25, 0, "code50", 50 },
                    { "cf11e02a-20d9-4742-aec0-db5a5520f0fb", 20, 0, "code10", 10 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "731b6a5f-fddb-40bf-aadc-af2fc20c1b1f", "FeatureHome2", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur vitae nunc eget leo finibus luctus et vitae lorem", "https://drive.google.com/uc?export=download&id=12xlH3LvPKtXEUTRFdETM7SGvCnjU9S-c", "Customer 2", 5, "Profession" },
                    { "547e59bc-14ff-422e-9e9a-be2702089b0d", "FeatureHome1", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur vitae nunc eget leo finibus luctus et vitae lorem", "https://drive.google.com/uc?export=download&id=12BEbKPhMNT6Gl31Wgzo1XNA6kf5zCtYm", "Customer 1", 5, "Profession" },
                    { "9a0164da-2861-47f1-9375-c291c08979ae", "FeatureHome3", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur vitae nunc eget leo finibus luctus et vitae lorem", "https://drive.google.com/uc?export=download&id=1-VztC3V4O7HyIdetuemHMO61M5up94uD", "Customer 3", 5, "Profession" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "360E601E-92F2-4F08-832B-604A21293258", "d51d6f75-0cd6-4b9b-b085-459058ec12e0", "admin", "AppRole", "admin", null },
                    { "f49e4348-718f-43e3-b1f6-6dc89c5Bb4fd", "c239d8b3-85f0-4924-8e05-20d6da34465f", "Staff", "AppRole", "staff", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "f49e4348-718f-43e3-b1f6-6dc89c5Bb5ff", 0, "bc551527-c552-4292-a969-a3bc4a409969", "AppUser", new DateTime(2020, 3, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "staff@gmail.com", true, "staff", "staff", false, null, "STAFF@GMAIL.COM", "STAFF@GMAIL.COM", "AQAAAAEAACcQAAAAELrEFr8vsP08NGXVR7Sn8kxhfJ5myWycMWpvUFLI8b4t5j/Sz8qNaypdgYdeI1jUYw==", null, false, "6989f0c6-3883-4c25-938a-39bb91fd6acc", false, "Staff", null, null, null, null, null, null, null, null },
                    { "DE544998-A3CC-4E12-ABB4-0642E57BD222", 0, "4f5ebc7a-b22f-4a4a-aba5-97b1ed01427d", "AppUser", new DateTime(2020, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", true, "admin", "admin", false, null, "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "AQAAAAEAACcQAAAAEAhoZdozLDbp7wzI1pKoNPBIAwr8ZRNz1NbPnhvAir+Q5ggKc4n8sDOIHYRgKGopbQ==", null, false, "ddfe3533-15bf-4e1a-9495-17f5992e8ad7", false, "Admin", "HCM 1", "HCM 2", "HCM", "0123456789", "Viet Nam", "0112223344", "700000", "700000" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "AFD66490-12F5-4EA7-BFF6-425624290D6D", false, true, new DateTime(2021, 11, 4, 7, 12, 47, 72, DateTimeKind.Local).AddTicks(3533), false, false, 0, false, "", 2100, "Check Payment", "Blue|Red|Black|Green", "5|6|7|8", "product 5|product 6| product 7| product 8", "550|450|350|640", "7|8|9|14", "1|1|2|2", 10, "f49e4348-718f-43e3-b1f6-6dc89c5Bb5ff", false, false },
                    { "D269BF93-A5E2-4C4A-8146-9967DDE80D30", false, true, new DateTime(2021, 11, 4, 7, 12, 47, 70, DateTimeKind.Local).AddTicks(6388), false, false, 0, false, "", 2000, "Check Payment", "Blue|Red|Black|Green", "1|2|3|4", "product 1|product 2| product 3| product 4", "550|450|350|640", "7|8|9|14", "1|1|2|1", 10, "f49e4348-718f-43e3-b1f6-6dc89c5Bb5ff", false, false }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "D355458F-1DD3-4834-AA28-6DA34B6357FF", "code50", 50, "DE544998-A3CC-4E12-ABB4-0642E57BD222" },
                    { "72309286-ECBB-4D20-AD95-2819D31E3400", "code10", 10, "f49e4348-718f-43e3-b1f6-6dc89c5Bb5ff" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "a4695a2d-7c1c-4c7a-af6e-26d2eb6261cb", "subreview 3", new DateTime(2020, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), false, "f49e4348-718f-43e3-b1f6-6dc89c5Bb5ff", "SubReview" },
                    { "cff06193-9736-4998-ac21-b19dcd01549c", "subreview 3", new DateTime(2020, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), false, "DE544998-A3CC-4E12-ABB4-0642E57BD222", "SubReview" },
                    { "1a62cec4-0bb0-4baa-8413-39b6982dc5ad", "subreview 1", new DateTime(2020, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), false, "DE544998-A3CC-4E12-ABB4-0642E57BD222", "SubReview" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "D355458F-1DD3-4834-AA28-6DA34B6357FF", "fad5f07b-e5e2-47fd-affc-78137549c334", 1, 2, "blue", "7" },
                    { "D355458F-1DD3-4834-AA28-6DA34B6357FF", "47426cac-17cf-4ca3-8b9e-6bfbe0dbd2d2", 2, 3, "blue", "7.5" },
                    { "D355458F-1DD3-4834-AA28-6DA34B6357FF", "7f0d01f9-7324-41f3-90e0-52594aab2727", 3, 1, "blue", "8" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "EEBA6608-AB75-4E83-909F-604B1A06F16C", "1a62cec4-0bb0-4baa-8413-39b6982dc5ad" },
                    { "9EED8607-D2BB-45EE-AEE3-C59D858A7F97", "cff06193-9736-4998-ac21-b19dcd01549c" },
                    { "EEBA6608-AB75-4E83-909F-604B1A06F16C", "a4695a2d-7c1c-4c7a-af6e-26d2eb6261cb" }
                });
