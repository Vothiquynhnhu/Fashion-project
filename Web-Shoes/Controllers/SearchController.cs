...
namespace Web_Shoes.Controllers
{
    public class SearchController : Controller
    {
        ...
        [HttpGet("{id}")]
        public IActionResult Index(string priceOrder, string sortOrder, string currentFilter, string searchString, int? pageNumber, string searchAll)
        {
            ...
            {
                query = query.Where(s => s.a.pd_Name.Contains(searchAll)
                                       || s.a.pd_Description.Contains(searchAll));
            }
